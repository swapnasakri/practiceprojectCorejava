...
public class Lockedme {
    ...
    public  static final String WELCOME_TO_THE_MENU =
            "\n********* Lockedme*********"+
                    "\n..............swapna sakri ...........\n";

   public  static final String MAIN_RECORDS =
            "\nMAIN MENU - Select any of the following: \n"+
                    "1 -> List files in directory\n"+
                    "2 -> Add, Delete or Search\n"+
                    "3 -> Exit Program";

    public  static final String SECONDARY_RECORDS =
    ...
    void showPrimaryMenu() {
        System.out.println(MAIN_RECORDS);
        try{
    ...
    void showSecondaryMenu() {
        System.out.println(SECONDARY_RECORDS);
        try{
            Scanner scanner = new Scanner(System.in);
	...
	public static void main(String[] args) {
		...
		System.out.println(WELCOME_TO_THE_MENU);
